...
The canonical shape for every synthetic persona generated by `bimstack:synthetic-research`. Follow this schema exactly so packs are consistent across services and rounds.
...
When no data exists for a field, mark it as an assumption using the bimstack convention:
